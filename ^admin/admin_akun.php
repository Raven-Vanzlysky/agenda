<?php
 ...
 // membatasi halaman sesuai user login
  ...
  if(isset($_POST['cari'])) 
  {
    $kata_cari = htmlspecialchars($_POST['kata_cari']);
...
<main class="container">
              ...
              <?php foreach ($data_guru as $x) : ?>
                <tr style="height: 15px;">
                  ...
                  <td class="text-center">
                    <button type="button" class="btn btn-success mb-1" data-bs-toggle="modal" data-bs-target="#modalUbah<?= $x['nip']; ?>">
                      <svg 
                    ...
                    <button type="button" class="btn btn-danger mb-1" data-bs-toggle="modal" data-bs-target="#modalHapus<?= $x['nip']; ?>">
                      <svg 
  ...
  <!-- Modal Akun -->
    <div class="modal-akun">
      ...
      <!-- Modal Ubah Akun -->
        <?php foreach ($data_guru as $x) : ?>
          <div class="modal fade" id="modalUbah<?= $x['nip']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
              <div class="modal-content">
      ...
      <!-- Modal Hapus Akun -->
        <?php foreach ($data_guru as $x) : ?>
          <div class="modal fade" id="modalHapus<?= $x['nip']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
              <div class="modal-dialog">
                  <div class="modal-content">
