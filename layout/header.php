      ...
      <nav id="themeNavbar" class="navbar bg-secondary navbar-expand-lg mt-1 ms-1 me-1">
        <div class="container-fluid d-flex justify-content-between align-items-center">
            ...
            <a class="navbar-brand animate__animated animate__bounceIn" href="https://www.instagram.com/ioreum.d?igsh=YnVrbWlwMXdkbGpo">
              <img src="../img/g1.png" width="75" height="75" alt="Gambar">
            </a>
            <button 
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <?php if ($_SESSION['level'] == 'Admin') : ?>
                      <li><a class="dropdown-item" href="index.php">
                        <svg 
                          xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-house-fill" viewBox="0 0 16 16">
                    ...
                    <?php if ($_SESSION['level'] == 'Guru') : ?>
                      ...
                      <li><a class="dropdown-item" href="main.php">
                        <svg 
                          xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-journal-text" viewBox="0 0 16 16">
                      ...
                      <li><a class="dropdown-item" href="agenda_pengajaran.php">
                        <svg 
                          xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-journal-bookmark" viewBox="0 0 16 16">
                      ...
                      <li><a class="dropdown-item" href="#">
                        <svg 
                          xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-clipboard2-check" viewBox="0 0 16 16">
              ...
              <?php foreach ($data_profile as $x) : ?>
                <a class="navbar-brand animate__animated animate__bounceIn" data-bs-toggle="dropdown" aria-expanded="false">
                  <img src="../client/foto/<?= $x['foto'] ?>" class="rounded-circle border border-3 img-fluid" style="width: 50px; height: 50px; object-fit: cover;" alt="Gambar">
                </a>
                ...
                <ul style="margin-top: -10px;" class="dropdown-menu dropdown-menu-end me-3">
                    ...
                    <li><a class="dropdown-item" href="#">
                    <svg 
                      xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-gear-wide-connected" viewBox="0 0 16 16">
                    ...
                    <svg 
                      xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-box-arrow-left" viewBox="0 0 16 16">
                  ...
                  <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="fotoLama" value="<?= $x['foto']; ?>">
                      ...
                      <div class="form-group mb-3">
                        ...
                        <div class="mt-1">
                          <img src="../client/foto/<?= $x['foto']; ?>" alt="" class="img-thumbnail img-preview" width="100px">
                        </div>
                    </div>
